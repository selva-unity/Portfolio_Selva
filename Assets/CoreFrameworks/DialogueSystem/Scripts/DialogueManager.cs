...
public class DialogueManager : MonoBehaviour
{
    ...
    public void ShowDialogue(SceneNarration sceneNarration, bool isVoiceOnly, Action callback)
    {
        dialogueCoroutine = StartCoroutine(ShowDialogueCoroutine(sceneNarration, isVoiceOnly, callback));
    }

    private IEnumerator ShowDialogueCoroutine(SceneNarration sceneNarration, bool isVoiceOnly, Action callback)
    {
        var narration = convoSO.convoScenes.Where(x => x.narration == sceneNarration).FirstOrDefault();
